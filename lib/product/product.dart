...
class Product {
  ...
  static List<Product> getProducts() {
    ...
    items.add(Product("Pixel", "Pixel is the most feature-full phone ever1234342!21", 800, "pixel.jpg"));
    items.add(Product("Laptop", "Laptop is most productive development tool", 2000, "laptop.jpg"));
